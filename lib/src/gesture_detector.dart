...
class _SlidableGestureDetectorState extends State<SlidableGestureDetector> {
  ...
  void handleDragStart(DragStartDetails details) {
    ...
    if(widget.controller.ratio==-0.35){
      widget.controller.ratio=-0.25;
    }
    print('handleDragStart widget.controller.ratio==>${widget.controller.ratio}');
  }
  ...
  void handleDragUpdate(DragUpdateDetails details) {
    ...
    print(' widget.controller.ratio==>${ widget.controller.ratio}');
  }
